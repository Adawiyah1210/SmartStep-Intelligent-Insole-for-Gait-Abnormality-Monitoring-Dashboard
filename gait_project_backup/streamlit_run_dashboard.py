...
if uploaded_csv:
    ...
    sns.heatmap(corr_matrix, annot=True, annot_kws={"size":6}, cmap=cmap, fmt=".2f", linewidths=0.5, square=True, ax=ax_corr)
    ax_corr.set_title(f"Correlation Heatmap - {label.capitalize()}", fontsize=10)
